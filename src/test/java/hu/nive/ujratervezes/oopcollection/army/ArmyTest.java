...
class ArmyTest {
    ...
    void testArcher() {
        ...
        assertEquals(30, archer.getBleeding());
    }
    ...
    void testHeavyCavalry() {
        ...
        assertEquals(140, heavyCavalry.getBleeding());
    }
    ...
    void testSwordsmanArmored() {
        ...
        assertEquals(100, swordsman.getBleeding());
        swordsman.sufferDamage(20);
        assertEquals(90, swordsman.getBleeding());
    ...
    void testSwordsmanUnarmored() {
        ...
        assertEquals(100, swordsman.getBleeding());
        swordsman.sufferDamage(20);
        assertEquals(80, swordsman.getBleeding());
        assertEquals(10, swordsman.doDamage());
    }
}